 ...
 */
class Version20180429031633 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE quotation_main (id INT AUTO_INCREMENT NOT NULL, is_active TINYINT(1) DEFAULT NULL, requerimiento_id INT DEFAULT NULL, estado VARCHAR(45) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
