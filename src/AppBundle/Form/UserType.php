...
//            ])
            ->add('image', TextType::class, [
                'label' => 'image',
                'required' => true,
                'data' => 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQuvnD8Z4Y8HdRYoidxmHLl7G_u8551SRmPjlEY_Hnz-YEuU-OF',
                'label_attr' => [
                    'class' => '',
                ],
                'attr' => [
                    'class' => 'form-control',
                    'placeholder' => 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQuvnD8Z4Y8HdRYoidxmHLl7G_u8551SRmPjlEY_Hnz-YEuU-OF',
                ],
            ])
